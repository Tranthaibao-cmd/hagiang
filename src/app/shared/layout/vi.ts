export const l10n = {
  grid: {
    ...
    EditOperationAlert:
      'Không có bản ghi nào được chọn để thực hiện thao tác chỉnh sửa',
    DeleteOperationAlert:
      'Không có bản ghi nào được chọn để thực hiện thao tác Xóa',
    SaveButton: 'Lưu',
    OKButton: 'Đồng ý',
    CancelButton: 'Hủy',
  ...
  'multi-select': {
    overflowCountTemplate: '+${count} đã chọn',
    totalCountTemplate: '${count} đã chọn',
