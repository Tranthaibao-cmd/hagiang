export const list = {
  periodList: [
    ...
    { name: 'Năm', value: 'Nam' },
    { name: '6 Tháng Đầu Năm', value: '6 thang dau'},
    { name: '6 Tháng Cuối Năm', value: '6 thang cuoi'},
    { name: '9 Tháng', value: '9 thang'},
  ],
  tabList: [
    { name: 'Báo cáo cấp huyện', value: 'Huyen tong hop' },
    { name: 'Báo cáo cấp sở', value: 'So tong hop' },
    { name: 'Báo cáo cấp tỉnh', value: 'Tong hop bao cao' },
  ],
  fields: { text: 'name', value: 'value' },
  ds_mau_bao_cao: [
    { name: 'Báo cáo tổng hợp', value: 'Bao cao tong hop' },
    { name: 'Báo cáo theo các huyện', value: 'Bao cao theo cac huyen' },
  ],
};
